...
\begin{figure}[H]
\center
\includegraphics[width=0.6\textwidth]{./img/ex_rgb_avant.PNG}
\caption{\label{} Filtrage RGB rouge : avant}
\end{figure}

\begin{figure}[H]
\center
\includegraphics[width=0.6\textwidth]{./img/ex_rgb_apres.PNG}
...
\begin{figure}[H]
\center
\includegraphics[width=0.6\textwidth]{./img/1_red.PNG}
\caption{\label{} Filtrage HSV rouge : avant}
\end{figure}

\begin{figure}[H]
\center
\includegraphics[width=0.6\textwidth]{./img/2_red.PNG}
...
\begin{figure}[H]
\center
\includegraphics[width=0.5\textwidth]{./img/3_white.PNG}
\caption{\label{} Filtrage RGB blanc : après}
\end{figure}

\begin{figure}[H]
\center
\includegraphics[width=0.5\textwidth]{./img/2_white.PNG}
...
\begin{figure}[H]
\center
\includegraphics[width=0.5\textwidth]{./img/scalar_avant.png}
\caption{\label{} Filtrage scalaire : avant}
\end{figure}

\begin{figure}[H]
\center
\includegraphics[width=0.5\textwidth]{./img/scalar_apres.png}
...
Globalement, c'est un projet transversal qui s'est bien déroulé, et a été très enrichissant sur les connaissances acquises dans le domaine du nuage de points. Nous avons pu découvrir une jeune entreprise qui cherche à innover dans ce domaine, et nous avons eu l'occasion de communiquer avec le créateur du logiciel CloudCompare, qui est considéré comme un logiciel majeur pour le traitement de nuage de points 3D.
