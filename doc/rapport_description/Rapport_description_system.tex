...
Les utilisateurs pourront y accéder en les sélectionnant dans le menu défilant qui liste les différents plugins présents. Les diagrammes de séquence qui suivent, détaillent le fonctionnement et l'expérience utilisateur.
...
Les actions utilisateurs sont également géré grâce à Qt au travers de la mécanique des signaux.
