...
\noindent\begin{tabularx}{17cm}{|p{2.5cm}|p{2.5cm}|p{1cm}|p{1.5cm}|p{2.5cm}|X|}
    ...
    \textbf{Tâche} & \textbf{Nature} & \textbf{Qui} & \textbf{Temps} & \textbf{Réalisation} & \textbf{Commentaire} \\
    \hline
    Préparation de la soutenance & concertation/production & ML, TTT, RC & indéterminé & En cours & Définition de ce qui sera dit, mise en place du support visuel\\
    \hline
    Cahier des charges & production & ML, TTT, RC & 3 h & Dernières modifications et corrections sur le cahier des charges suivant la demande du client et du tuteur \\
    \hline
\end{tabularx}
