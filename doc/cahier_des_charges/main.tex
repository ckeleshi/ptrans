...
En tant qu'utilisateur du logiciel, je souhaite enregistrer les modifiactions que j'ai effectué en exportant le nuage de points actuel sous la forme d'un fichier pouvant être ouvert dans un autre programme.
...
Aucun format n'est choisis par défaut\\
Je choisis l'ordre des colonnes qui me convient en le cochant\\
Je clique sur le bouton Appliquer\\
La fenêtre se ferme\\
Une nouvelle fenêtre demandant de choisir un emplacement dans l'explorateur de fichier apparait\\
Je choisis une localisation dans l'explorateur de fichier\\
Et je choisis un nom\\
J'appuie sur le bouton d'enregistrement\\
Le fichier est enregistré à l'emplacement sélectionné avec le nom choisis.
...
J'appuie sur le bouton d'enregistrement\\
Alors un message d'erreur indiquant que le nom choisis est invalide apparait\\
...
J'appuie sur le bouton d'enregistrement\\
Alors un message d'alerte indiquant qu'un fichier portant le même nom existe déjà apparait, j'ai le choix d'écraser ou d'annuler\\
Je choisis d'écraser le fichier\\
Alors le fichier est enregistré à l'emplacement sélectionné avec le nom choisis, remplaçant le fichier existant.
