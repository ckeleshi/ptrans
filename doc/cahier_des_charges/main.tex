...
\begin{figure} [!hbtp]
 \centering
    ...
    \includegraphics[scale=1,origin=c]{tableau_gantt_general.PNG}
\end{figure}
\break
\begin{figure} [!hbtp]
 \centering
    ...
    \includegraphics[scale=0.6, origin=c]{affichage_gantt_general.PNG}
\end{figure}
...
\begin{figure} [!hbtp]
 \centering
    ...
    \includegraphics[scale=1,origin=c]{tableau_gantt_iteration1.PNG}
\end{figure}
\break
\begin{figure} [!hbtp]
 \centering
    ...
    \includegraphics[scale=0.6, origin=c]{affichage_gantt_iteration1.PNG}
\end{figure}
