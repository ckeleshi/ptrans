...
Le MOA, ou maître d'ouvrage, est la partie cliente, elle représente l'entreprise formulant le besoin.
...
Le MOE, ou maître d'oeuvre, correspond au groupe responsable de la conception de la solution.
Le MOE dispose du choix des moyens techniques.
Dans le cadre de notre projet, la partie MOE est confondue avec l'équipe de développement, étant donné quelle est responsable à la fois de la conception et du développement.
...
Il constitue une source de conseil sur le MOE mais est aussi capable de lui appliquer des contraintes techniques. 
...
Le diagramme d'utilisation suivant décrit le fonctionnement global de l'application.
Il comprend les différentes actions que permet la solution.
\begin{figure}
    \centering
