...
Elle se veut un complément à PCL.
...
\noindent\begin{tabu} to \textwidth {p{0.15\textwidth}X[c3]X[c3]X[c3]}\toprule
    \thead{Bibliothèque}&\thead{Licence}&\thead{Langages}&\thead{Fonctionnalités}\\\toprule
PCL
& BSD
& C++, Python
& Filtrage, segmentation, reconnaissance, visualisation.\\\midrule
Open3D
& MIT
& C++, Python
& Traitement général de la 3D.\\\midrule
PDAL
& BSD
& C++, Python
& Complémentaire à PCL, utilisation de "pipelines" pour lier les traitements.\\\bottomrule
\end{tabu}
