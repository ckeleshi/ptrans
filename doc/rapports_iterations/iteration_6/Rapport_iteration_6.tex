...
Ainsi, un champs texte mis à jour en fonction de l'indice saisi par l'utilisateur a été ajouté, ce champs explicite le nombre de couleur.
L'utilisateur peut visualiser visualiser l'indice dont qu'il sélectionnera suivant le nombre de couleurs dont il a besoin.
